...
// Video array for easy management and future additions
const videos = [
  {
    id: 1,
    embedUrl: "https://www.youtube.com/embed/vXxBC-8satU?si=hYlXzu1ISc8rzU2I",
    title: "YouTube video player"
  },
  {
    id: 2,
    embedUrl: "https://www.youtube.com/embed/RpAGBCKqfQQ?si=jXPGfw89ZRqUQmVB",
    title: "YouTube video player"
  }
];
  ...
  <section className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Watch our impactful moments and educational content in action
        </p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {videos.map((video) => (
          <div key={video.id} className="relative overflow-hidden rounded-xl shadow-lg bg-gray-100">
